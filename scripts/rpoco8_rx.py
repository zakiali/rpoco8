...
class DataRecorder(S.ItemGroup):
    def __init__(self, sdf, sfreq, nchan, inttime, calfile='psa6240_v003',
            samp_rate=200e6, bandpass=None):
...
dr = DataRecorder(sdf, sfreq, nchan, inttime, bandpass=None, calfile='psa898_v003')
dr.open_uv()
