...
function pfb_core_v5_config(this_block)

  % Revision History:
  %
  %   05-Sep-2014  (23:28 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/domagalski/wrk/pocket_corr/pfb_core_v5.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('pfb_core_v5');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfb_core_v5.vhd');
